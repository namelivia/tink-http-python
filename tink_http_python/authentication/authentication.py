...
class Authentication:
    ...
    def get_authorization_code_link(self):
        return f"https://link.tink.com/1.0/transactions/connect-accounts/?client_id={self.config.client_id}&redirect_uri={urlencode(self.config.redirect_uri)}&market=ES&locale=es_ES"
